  ...
  return (
    <Box>
      <Typography
        ...
        variant="h5"
      >
        {engToBdNum(index + 1)}. সেলস্ অফিসার এর ইনফরমেশন
      </Typography>
      {/* address  */}
      <Box
        sx={{
      ...
      >
        ...
        <Box>
          <Controller
            name={`officer.${index}.name`}
            control={control}
            rules={{
              required: {
                value: true,
                message: 'সেলস্ অফিসার এর নাম প্রয়োজন',
              },
            }}
            render={({ field, fieldState: { error } }) => (
              <>
                ...
                <TextField
                  ...
                  variant="outlined"
                  type="text"
                  placeholder="সেলস্ অফিসার এর নাম"
                  {...field}
                  error={Boolean(error)}
                  helperText={Boolean(error) && error?.message}
                  sx={{
...
export default AddSalesOfficerFields;
